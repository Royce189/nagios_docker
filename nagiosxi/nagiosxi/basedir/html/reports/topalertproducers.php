...
function get_topalertproducers_report()
{
    ...
    <?php
        ...
        <button class="btn btn-xs btn-default tt-bind jump btn-flex" title="'. _('Jump to Page') .'"><i class="material-symbols-outlined md-16 md-400e">expand_circle_right</i></button>';
        }
    ...
    <div class="ajax-pagination report-pagination  neptune-ajax-pagination">
        <div class="pagination-ctrl">
            <button class="<?php if (get_theme() == 'neptune') {echo 'reports-';} ?>btn btn-xs btn-default first-page btn-flex" title="<?php echo _('Last Page'); ?>"><i class="material-symbols-outlined md-20 md-400e">keyboard_double_arrow_left</i></button>
            <button class="<?php if (get_theme() == 'neptune') {echo 'reports-';} ?>btn btn-xs btn-default previous-page btn-flex" title="<?php echo _('Previous Page'); ?>" disabled><i class="material-symbols-outlined md-20 md-400">keyboard_arrow_left</i></button>
            <span class="page-count-margin"><?php echo $jump_to; ?></span></span>
            <button class="<?php if (get_theme() == 'neptune') {echo 'reports-';} ?>btn btn-xs btn-default next-page btn-flex" title="<?php echo _('Next Page'); ?>"><i class="material-symbols-outlined md-20 md-400">keyboard_arrow_right</i></button>
            <button class="<?php if (get_theme() == 'neptune') {echo 'reports-';} ?>btn btn-xs btn-default last-page btn-flex" title="<?php echo _('Last Page'); ?>"><i class="material-symbols-outlined md-20 md-400">keyboard_double_arrow_right</i></button>
        </div>
...
$(document).ready(function() {
    ...
    <div class="ajax-pagination">
        ...
        <select class="report-item-count form-control <?php if (get_theme() != 'neptune') { echo 'condensed'; } ?> num-records">
            <option value="5"<?php if ($pager_results['records_per_page'] == 5) { echo ' selected'; } ?>>5 <?php echo _('Per Page'); ?></option>
            <option value="10"<?php if ($pager_results['records_per_page'] == 10) { echo ' selected'; } ?>>10 <?php echo _('Per Page'); ?></option>
            <option value="25"<?php if ($pager_results['records_per_page'] == 25) { echo ' selected'; } ?>>25 <?php echo _('Per Page'); ?></option>
            <option value="50"<?php if ($pager_results['records_per_page'] == 50) { echo ' selected'; } ?>>50 <?php echo _('Per Page'); ?></option>
