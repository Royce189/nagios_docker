...
<form method="get" data-type="execsummary">
    <div class="well report-options form-inline">
        ...
        <div class="reportexportlinks">
            ...
            <a title='<?php echo _("Download as PDF"); ?>' class='btn btn-sm btn-default tt-bind icon-in-btn btn-export' data-placement='bottom' data-type="pdf" ><i class='material-symbols-outlined md-middle md-400'>picture_as_pdf</i></a>
        </div>
...
function get_execsummary_report()
{
    ...
    <div id='allreports' style='margin:10px auto;'>
        ...
        <?php
            $local_export = 'false';
            // check local exporting option
            if (get_option('reports_exporting')) {
                $local_export = 'true';
            }
        ?>
            ...
            <div id='inner_alert_histogram'>
                ...
                <script type="text/javascript">
                    $(document).ready(function () {
                        ...
                        $.getJSON(api_url,
                            function (data) {
                                if (<?php echo $local_export?> == false) {
                                    url = 'https://export.highcharts.com/'
                                } else {
                                    url = '<?php echo get_base_url()."/includes/components/highcharts/exporting-server/index.php"; ?>'
                                }
                                var chart;
                                var options = {
                                    'exporting' : {
