            ...
            <div class="btn-group">
                <button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                 ...
                 <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
                    ...
                    <li><a class="btn-export" data-type="pdf" title="<?php echo _("Download as PDF"); ?>"><i class="material-symbols-outlined md-16 md-400 md-middle">picture_as_pdf</i> <?php echo _("PDF"); ?></a></li>
                </ul>
            </div>
        </div>
...
?>
        ...
        <?php $state_width = (get_theme() == "neptune") ? '110px' : '80px'; ?>
            ...
            if ($xml) {
                if ($total_records == 0) {
                    ...
                    foreach ($xml->stateentry as $se) {
                        ...
                        $status_bubble = (get_theme() == "neptune") ? '<span class="status-dot ' . $dotcolor . ' dot-10"></span>' : '';
                        $tdclass = (get_theme() == "neptune") ? 'neptune-td-nowrap' : $tdclass;
                        $info_class = (get_theme() == "neptune") ? "class='mono text-black-blue-200'" : "";
...
function get_statehistory_report()
{
    ...
    <?php
        if (get_theme() == "neptune") {
        $jump_to = '<span class="pager-select-page">
            <span>
                '._('Page').'
            </span>
            ...
            $jump_to = _('Page') . ' <span class="pagenum"> 1 ' . _('of') . $pager_results['total_pages'];
            $old_page_select = '<input type="text" class="form-control condensed jump-to">
        <button class="btn btn-xs btn-default tt-bind jump btn-flex" title="'. _('Jump to Page') .'"><i class="material-symbols-outlined md-16 md-400 md-middle">expand_circle_right</i>';
        }
    ...
    <div class="ajax-pagination report-pagination  neptune-ajax-pagination">
        <div class="pagination-ctrl">
            <button class="<?php if (get_theme() == 'neptune') {echo 'reports-';} ?>btn btn-xs btn-default first-page btn-flex" title="<?php echo _('Last Page'); ?>"><i class="material-symbols-outlined md-20 md-400 md-middle">keyboard_double_arrow_left</i></button>
            <button class="<?php if (get_theme() == 'neptune') {echo 'reports-';} ?>btn btn-xs btn-default previous-page btn-flex" title="<?php echo _('Previous Page'); ?>" disabled><i class="material-symbols-outlined md-20 md-400 md-middle">keyboard_arrow_left</i></button>
            <span class="page-count-margin"><?php echo $jump_to; ?></span></span>
            <button class="<?php if (get_theme() == 'neptune') {echo 'reports-';} ?>btn btn-xs btn-default next-page btn-flex" title="<?php echo _('Next Page'); ?>"><i class="material-symbols-outlined md-20 md-400 md-middle">keyboard_arrow_right</i></button>
            <button class="<?php if (get_theme() == 'neptune') {echo 'reports-';} ?>btn btn-xs btn-default last-page btn-flex" title="<?php echo _('Last Page'); ?>"><i class="material-symbols-outlined md-20 md-400 md-middle">keyboard_double_arrow_right</i></button>
        </div>

        <select class="form-control <?php if (get_theme() != 'neptune') { echo 'condensed'; } ?> num-records">
