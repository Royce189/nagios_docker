...
<table class="table table-condensed table-hover table-bordered table-striped<?php if ($export) { echo ' table-export'; } ?>">
    ...
    if ($xml) {
        foreach ($xml->logentry as $le) {
            ...
            echo '<td class="mono text-black-blue-200"><div class="scrollable-70">' . $entrytext . '</div></td>';
            echo '</tr>';
        }
    }
    ?>
    ...
    <?php
        ...
        $jump_to = '<span class="pager-select-page">
            ...
            <span>
                ...
                <span class="neptune-slash-small">/</span>  <span class="neptune-text-muted pagetotal pagination-total">'.$pager_results["total_pages"].'</span>
            </span>
        </span>';
        } else {
        ...
        <button class="btn btn-xs btn-default tt-bind jump btn-flex" title="'. _('Jump to Page') .'"><i class="material-symbols-outlined md-16 md-400 md-middle">expand_circle_right</i></button>';
        }
    ?>
