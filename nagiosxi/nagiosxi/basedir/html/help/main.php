...
?>
    ...
    <div style="width: 500px; float: left;">
        ...
        <ul class="neptune-form-subtext">
            <li>
                <a href='https://support.nagios.com/nagios-xi-resources/#faq' target="_blank" rel="noreferrer"><b><?php echo _("Frequently Asked Questions"); ?></b></a>
            </li>
            <li><a href='https://library.nagios.com/' target="_blank" rel="noreferrer"><b><?php echo _("Visit the Nagios Library"); ?></b></a></li>
            <li><a href='https://support.nagios.com/forum' target="_blank" rel="noreferrer"><b><?php echo _("Visit the Support Forum"); ?></b></a></li>
            <li><a href='https://support.nagios.com/wiki' target="_blank" rel="noreferrer"><b><?php echo _("Visit the Support Wiki"); ?></b></a></li>
        </ul>
