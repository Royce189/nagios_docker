        ...
        <div id="tabs" class="hide">
                ...
                <table class="table table-condensed table-no-border table-auto-width">
                    ...
                    <tr id='phpmailerlogging'>
                        ...
                        <?php } else { ?>
                            <td>
                                <?php
                                echo neptune_centered_checkbox(_('Enable logging of mail sent with the internal mail component (PHPMailer) <b>') . get_tmp_dir() . '/phpmailer.log</b>', "debug", "debug", $debug, 1);
                                ?>
                            </td>
                        <?php } ?>
                    </tr>
            ...
            <div id="inbound">
                ...
                <?php
                    ...
                    if (preg_match('/CentOS/', $osfilecontents) || preg_match('/Red Hat/', $osfilecontents) || preg_match('/Oracle/', $osfilecontents)) {
                        if (preg_match('/VERSION_ID="9/', $osfilecontents)) {
                            echo '<p class="alert alert-info" style="margin-top: 10px;">'._('You are running CentOS/RHEL/Oracle 9. PHP-IMAP is not supported on this version of CentOS. We are working on a solution for this issue.').'</p>';
                            echo "
                                <script>
                                    $(document).ready(function(){
                ...
                <?php } else { ?>
                    <div class="btn-row">
                        <?php
                        echo neptune_centered_checkbox(_('Enable incoming email processing'), "mail_inbound_process", "mail_inbound_process", $mail_inbound_process, 1);
                        ?>
                ...
                <script>
                    $(document).ready(function() {
                        if ($('input[name="mail_inbound_encryption"]:checked').val() == 'none') {
                            $('input[name="mail_inbound_validate"]').prop('disabled', true).prop('checked', false);
                        }
                    });
                    $('input[name="mail_inbound_encryption"]').on('change', function() {
                        if ($(this).val() == 'none') {
                            $('input[name="mail_inbound_validate"]').prop('disabled', true).prop('checked', false);
                        } else {
                            $('input[name="mail_inbound_validate"]').prop('disabled', false);
                        }
                    });
                </script>
            </div>
