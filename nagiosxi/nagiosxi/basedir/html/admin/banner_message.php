        ...
        <div style="display: inline-block; flex-grow: 1;">
            ...
            <script>
                ...
                $("#banner_message_wrapper .ajax-pagination .jump-to").on('keypress', function (e) {
                    if (e.keyCode === 13) {
                        theme == "neptune" ? $(this).closest(".xi-pager").find(".jump").click() : $(this).parent().children(".jump").click();
                    }
                });
                ...
                $("#banner_message_wrapper .ajax-pagination .jump").on('click', function () {
                    def_current_page = (theme == "neptune") ? $(this).closest(".xi-pager").find(".jump-to").val() : $(this).parent().children(".jump-to").val();
                    update_banner_message_table();
                });
                ...
                function update_banner_message_table() {
                    ...
                    $.get(url, {}, function(data) {
                        ...
                        theme == "neptune" ? $('.ajax_banner_message_page_total').html(def_max_page) : $('.ajax_banner_message_page_total').html(page_display_string);
