            ...
            <table class="editDataSourceTable table table-condensed table-no-border" cellpadding="2">
                ...
                <tr class="pw">
                    ...
                    <td style="line-height: 18px; vertical-align: middle;">
                        <input type="checkbox" id="sendEmailBox" name="sendemail" style="margin: 0; vertical-align: text-top;" <?= (empty($password1) ? 'disabled' : '') ?> <?= $sendemailchecked; ?>> &nbsp;
                ...
                <tr class="lo">
                    ...
                    <td>
                        <input type="checkbox" class="checkbox" id="forcePasswordChangeBox" name="forcepasswordchange" <?= $forcechangechecked ?>>
                    </td>
                </tr>
            </table>
<?php
...
<?php
        echo neptune_centered_checkbox($sendemailboxtitle, 'sendEmailBox', 'sendemail', $sendemailchecked, 1, (empty($password1) ? true : false));
?>
                        <div class="material-symbols-outlined tt-bind md-20" tabindex="99" title="<?= _('You must fill out a new password or click set to a random secure password before setting this option.') ?>">help</div>
                        <a class="set-random-pass text-medium"><?= _('Set to a random secure password') ?></a>
                    </div>
<?php
        echo neptune_centered_checkbox(_('Force password change at next login'), 'forcePasswordChangeBox', 'forcepasswordchange', $forcechangechecked, 1);
    }
...
<?php
        ...
        echo neptune_centered_checkbox($title, 'allow_local', 'allow_local', $sendemailchecked, 1, (($user_id == 1) ? true : false));
?>
                </div>
<?php
        // Let components add html to the edit/add user page (inside the authentication settings table)
...
?>
        ...
        <table class="editDataSourceTable ss-table table table-condensed table-no-border" cellpadding="2">
            ...
            <tr class="user-setting">
                ...
                <td>
                    <input type="checkbox" class="checkbox" id="autodeploy_access" name="autodeploy_access" <?= is_checked($autodeploy_access, 1); ?>>
                </td>
            </tr>
...
<?php
        ...
        echo "<div class='user-setting'>" . neptune_centered_checkbox(_('Can see all hosts and services'), 'aoo', 'authorized_for_all_objects', is_checked_admin($authorized_for_all_objects, 1, $level), "checked", '', $tooltip) . "</div>";

        $tooltip = '<div tabindex="3" class="material-symbols-outlined pop md-20" data-content="'._('Allows the user run commands on all hosts and services. These are commands that can be ran on the Nagios command file.').'<br><br><i>'._('Note: Without this option users are still allowed to run commands on hosts and services they are contacts of. This is normally used if you have selected the').' <b>'._('Can see all hosts and services').'</b> '._('above').'.</i>">help</div>';

        echo "<div class='user-setting'>" . neptune_centered_checkbox(_('Can control all hosts and services'), 'aaoc', 'authorized_for_all_object_commands', is_checked_admin($authorized_for_all_object_commands, 1, $level), "checked", '', $tooltip) . "</div>";

        $tooltip = '<div tabindex="4" class="material-symbols-outlined pop md-20" data-content="'._('Allows a user to be able to access the following for hosts and services:').'<ul style=\'margin: 0; padding: 10px 0 5px 20px;\'><li>'._('Run Configuration Wizards').'</li><li>'._('Delete from detail page').'</li><li>'._('Re-configure from detail page').'</li></ul>">help</div>';

        echo "<div class='user-setting'>" . neptune_centered_checkbox(_('Can configure hosts and services'), 'aco', 'authorized_to_configure_objects', is_checked_admin($authorized_to_configure_objects, 1, $level), "checked", '', $tooltip) . "</div>";

        $tooltip = '<div tabindex="5" class="material-symbols-outlined pop md-20" data-content="'._('Allows the editing of check command in the re-configure host/service page.<br><br>Shows advanced tab and commands in host/service detail pages.<br><br>Allows setting host parents during wizards and re-configure on host detail page.').'">help</div>';

        echo "<div class='user-setting'>" . neptune_centered_checkbox(_('Can access advanced features'), 'au', 'advanced_user', is_checked_admin($advanced_user, 1, $level), "checked", '', $tooltip) . "</div>";
        ...
        echo "<div class='user-setting'>" . neptune_centered_checkbox(_('Can access monitoring engine'), 'ams', 'authorized_for_monitoring_system', is_checked_admin($authorized_for_monitoring_system, 1, $level), "checked", '', $tooltip) . "</div>";

        $tooltip = '<div tabindex="7" class="material-symbols-outlined pop md-20" data-content="'._('Restrict the user to have read-only access.').'<br><br><i>'._('Note: This overwrites the following').':<ul style=\'margin: 0; padding: 10px 0 5px 20px;\'><li>'._('Can control hosts and services').'</li><li>'._('Can configure hosts and services').'</li><li>'._('Can access advanced features').'</li></ul></i>">help</div>';

        echo "<div class='user-setting'>" . neptune_centered_checkbox(_('Read-only access'), 'rou', 'readonly_user', is_checked_admin($readonly_user, 1, 0), "checked", '', $tooltip) . "</div>";
        ...
        echo neptune_centered_checkbox(_('API access'), 'api_enabled', 'api_enabled', $api_enabled, 1, '', $tooltip);
        ...
        echo "<div class='user-setting'>" . neptune_centered_checkbox(_('Auto deploy access'), 'autodeploy_access', 'autodeploy_access', $autodeploy_access, 1, '', $tooltip) . "</div>";
...
<?php
        ...
        echo neptune_centered_checkbox(_('Host Groups'), '', 'ccm_access_list[]', "hostgroup", (in_array('hostgroup', $ccm_access_list) ? 'hostgroup' : ''), 0, "", "hostgroup");
        echo neptune_centered_checkbox(_('Service Groups'), '', 'ccm_access_list[]', "servicegroup", (in_array('servicegroup', $ccm_access_list) ? 'servicegroup' : ''), 0, "", "servicegroup");

        echo neptune_section_spacer();
        echo neptune_subheading(_("Alerting Permissions"));
        echo neptune_centered_checkbox(_('Contacts'), '', 'ccm_access_list[]', "contact", (in_array('contact', $ccm_access_list) ? 'contact' : ''), 0, "", "contact");
        echo neptune_centered_checkbox(_('Contact Groups'), '', 'ccm_access_list[]', "contactgroup", (in_array('contactgroup', $ccm_access_list) ? 'contactgroup' : ''), 0, "", "contactgroup");
        echo neptune_centered_checkbox(_('Time Periods'), '', 'ccm_access_list[]', "timeperiod", (in_array('timeperiod', $ccm_access_list) ? 'timeperiod' : ''), 0), "", "timeperiod";
        echo neptune_centered_checkbox(_('Host Escalations'), '', 'ccm_access_list[]', "hostescalation", (in_array('hostescalation', $ccm_access_list) ? 'hostescalation' : ''), 0, "", "hostescalation");
        echo neptune_centered_checkbox(_('Service Escalations'), '', 'ccm_access_list[]', "serviceescalation", (in_array('serviceescalation', $ccm_access_list) ? 'serviceescalation' : ''), 0, "", "serviceescalation");

        echo neptune_section_spacer();
        echo neptune_subheading(_("Template Permissions"));
        echo neptune_centered_checkbox(_('Host Templates'), '', 'ccm_access_list[]', "hosttemplate", (in_array('hosttemplate', $ccm_access_list) ? 'hosttemplate' : ''), 0, "", "hosttemplate");
        echo neptune_centered_checkbox(_('Service Templates'), '', 'ccm_access_list[]', "servicetemplate", (in_array('servicetemplate', $ccm_access_list) ? 'servicetemplate' : ''), 0, "", "servicetemplate");
        echo neptune_centered_checkbox(_('Contact Templates'), '', 'ccm_access_list[]', "contacttemplate", (in_array('contacttemplate', $ccm_access_list) ? 'contacttemplate' : ''), 0, "", "contacttemplate");

        echo neptune_section_spacer();
        echo neptune_subheading(_("Command Permissions"));
        echo neptune_centered_checkbox(_('Commands'), '', 'ccm_access_list[]', "command", (in_array('command', $ccm_access_list) ? 'command' : ''), 0, "", "command");

        echo neptune_section_spacer();
        echo neptune_subheading(_("Advanced Permissions"));
        echo neptune_centered_checkbox(_('Host Dependencies'), '', 'ccm_access_list[]', "hostdependency", (in_array('hostdependency', $ccm_access_list) ? 'hostdependency' : ''), 0, "", "hostdependency");
        echo neptune_centered_checkbox(_('Service Dependencies'), '', 'ccm_access_list[]', "servicedependency", (in_array('servicedependency', $ccm_access_list) ? 'servicedependency' : ''), 0, "", "servicedependency");
?>
                        <p style="margin-top: 10px;"><?= _("Tools are only available if assigned below."); ?></p>
<?php
        echo neptune_section_spacer();
        echo neptune_subheading(_("Tool Permissions"));
        echo neptune_centered_checkbox(_('Static Config Editor'), '', 'ccm_access_list[]', "staticconfig", (in_array('staticconfig', $ccm_access_list) ? 'staticconfig' : ''), 0, "", "staticconfig");
        echo neptune_centered_checkbox(_('User Macros'), '', 'ccm_access_list[]', "usermacros", (in_array('usermacros', $ccm_access_list) ? 'usermacros' : ''), 0, "", "usermacros");
        echo neptune_centered_checkbox(_('Import Config Files'), '', 'ccm_access_list[]', "import", (in_array('import', $ccm_access_list) ? 'import' : ''), 0, "", "import");
        echo neptune_centered_checkbox(_('Config File Management'), '', 'ccm_access_list[]', "configmanagement", (in_array('configmanagement', $ccm_access_list) ? 'configmanagement' : ''), 0, "", "configmanagement");
        ...
        <table class="editDataSourceTable table table-condensed table-no-border table-auto-width">
            ...
            <tr>
                ...
                <td>
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" class="checkbox" id="sendEmailBox" name="sendemail" <?= $sendemailchecked; ?>>
...
<?php        
        ...
        echo neptune_centered_checkbox(_('Email user new password'), 'sendEmailBox', 'sendemail', $sendemailchecked, 1);
