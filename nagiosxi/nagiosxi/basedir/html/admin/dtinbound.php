        ...
        <form id="manageOptionsForm" method="post" action="dtinbound.php">
            ...
            <div id="tabs" class="hide neptune-subtext">
                ...
                <?php if ($have_configured_nsca != 1) { ?>
                    ...
                    echo neptune_section_spacer();
                    echo neptune_password("Password", $id, "nsca_password", encode_form_val($nsca_password), '<div>' . _('The password used to decrypt check data that is received by NSCA.') . '</div><div><b>' . _("Important") . ':</b> ' . _('Each sender must be using this same password.') . '</div>');
                    echo neptune_section_spacer();
                    ?>
