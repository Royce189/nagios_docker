...
?>
    ...
    $(document).ready(function () {
        ...
        if (theme != "neptune") { $('#hostListPerf').searchable({maxMultiMatch: 9999}); }
...
<form method="get" class="update-pf" action="">
    <div class="well report-options form-inline neptune-metric-well">
            ...
            <div class="input-group fl" style="width: 220px; margin-right: 20px;">
                ...
                <select style="width:150px" class="form-control" id="view" name="view">
            ...
            <div class="input-group fl" style="width: 220px; margin-right: 20px;">
                <label class="input-group-addon h-9"><?php echo _('Host'); ?></label>
                <select name="host" id="hostListPerf" data-full-width="1" class="rounded-l-none h-9 form-control">
                    <option value=""></option>
                    <?php
