...
?>
    ...
    <p class="subtext neptune-form-subtext"><?php echo _('Choose whether or not you want to receive alert messages'); ?>.<br><strong><?php echo _('Note'); ?>:</strong> <?php echo _('You must specify which notification methods to use in the'); ?> <a href="notifymethods.php"><?php echo _('notification methods'); ?></a> <?php echo _('page'); ?>.</p>

    <?php
    if ($lock_notifications) {
        $nmsg = array();
        $nmsg[] = '<div><strong>'._('Alert').'!</strong> '._('Notification settings have been locked for your account').'.</div>';
    ...
    <form id="updateNotificationPreferencesForm" method="post" action="">
        ...
        <?php if (get_theme() != 'neptune') { ?>
            <table class="table table-condensed table-no-border table-auto-width" style="margin-bottom: 10px;">
                <tr>
                    <td></td>
                    <td class="checkbox">
                        <label><input type="checkbox" class="checkbox" name="enable_notifications" <?php echo is_checked($enable_notifications, 1); ?>><span><?php echo _('Enable notifications'); ?></span></label>
                    </td>
                </tr>
            </table>
        <?php } else {
            echo neptune_section_spacer();
            echo neptune_centered_checkbox(_('Enable notifications'), 'enable_notifications', 'enable_notifications', $enable_notifications, 1);
        } ?>

        <div id="tabs" class="hide">
            <ul>
                <li><a href="#tab-email"><i class="material-symbols-outlined md-18">mail</i> <?php echo _('Email'); ?></a></li>
                <li><a href="#tab-sms"><i class="material-symbols-outlined md-18">call</i> <?php echo _('Mobile Text (SMS)'); ?></a></li>
                <li><a href="#tab-timeperiods"><i class="material-symbols-outlined md-18">alarm</i> <?php echo _('Time Periods'); ?></a></li>
            </ul>

            <div id="tab-email">

                <p class="subtext neptune-form-subtext"><?php echo _('Select the types of alerts you\'d like to receive'); ?>.</p>

                <table class="table table-condensed table-no-border table-auto-width">
                    <thead>
                        <tr>
                            <th></th>
                            <th><i class="material-symbols-outlined tt-bind icon-td" title="<?php echo _('Send email'); ?>">mail</i></th>
                            <th><i class="material-symbols-outlined tt-bind icon-td" title="<?php echo _('Send email high priority'); ?>">warning</i></th>
                            <th></th>
                            <th></th>
                            <th><i class="material-symbols-outlined tt-bind icon-td" title="<?php echo _('Send email'); ?>">mail</i></th>
                            <th><i class="material-symbols-outlined tt-bind icon-td" title="<?php echo _('Send email high priority'); ?>">warning</i></th>
            ...
            <div id="tab-sms">
                ...
                <table class="table table-condensed table-no-border table-auto-width neptune-table-no-left-padding">
                    <tbody>
                        <tr>
                            <td>
            ...
            <div id="tab-timeperiods">
                ...
                <p class="subtext neptune-form-subtext"><?php echo _("Specify the times of day you'd like to receive alerts."); ?></p>
