...
function fetch_piegraph($args)
{
    ...
    $graph = '';
    $green_value = ($theme == "colorblind") ? '#56B4E9' : '#b2ff5f';
    $red_value = ($theme == "colorblind") ? '#CC79A7' : '#FF795F';
    $orange_value = ($theme == "colorblind") ? '#D55E00' : '#FFC45F';
    $yellow_value = ($theme == "colorblind") ? '#F0E442' : '#FEFF5F';
    ...
    if (get_option('highcharts_local_export_server', 1)) {
        ...
        if ($ini['distro'] == "el9" || $ini['distro'] == "ubuntu22" || get_option('reports_exporting')) {
