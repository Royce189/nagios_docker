...
<div class="divtable">
    <div class="divtable-column" id="leftContainer" style="width: 20%; display: none;">
        ...
        <div id="host_service_selection">
            <h5 class="text-medium"><?php echo _("Graph Objects"); ?></h5>
            <div style="margin-bottom: 6px;">
                <label class = "text-small my-2" for='selectHost'><?php echo _("Select Host"); ?></label><br/>
            ...
            <div style="margin-bottom: 6px;">
                <label  class = "text-small my-2" for='selectService'><?php echo _("Select Service"); ?></label><br/>
            ...
            <div id="selectDataTypeBox" style="margin-bottom: 20px;">
                <label  class = "text-small my-2" for="selectDataType"><?php echo _("Select Data Type"); ?></label><br/>
            ...
            <h5 class="text-medium"><?php echo _("Filtering Options"); ?></h5>
            <div id="dateFilterTimeline">
                <label class="text-small my-2"><?php echo _("Time Period"); ?></label><br/>
    ...
    <div class="divtable-column" style="padding: 0 3px;">
        ...
        <div class="well neptune-graph-well" style="margin: 20px 0;">
