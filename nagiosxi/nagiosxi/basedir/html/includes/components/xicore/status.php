...
<div class="fl">
    <div>
    <h1 style="display: inline-block;"><?php echo _("Service Status");?><span class="hoststatustargettext"><span class="neptune-slash">/</span><?php echo strtolower($target_text);?></span>
