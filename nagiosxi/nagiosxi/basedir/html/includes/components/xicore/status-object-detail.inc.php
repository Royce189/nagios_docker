...
?>
    ...
    <h1 style="display:inline-block; margin-bottom:-10px;"><?php echo _("Service Status Detail"); ?><span class="hoststatustargettext"><span class="neptune-slash">/</span>
        <a href="<?php echo get_host_status_detail_link($host); ?>"><?php echo encode_form_val(strtolower($host)); ?></a>
        <span class="neptune-slash">/</span>
        <?php if ($display_service_display_name) { echo strtolower($displayname); } else { echo encode_form_val(strtolower($service)); } ?>
    </h1>
...
<?php if (is_neptune()) { ?>
    ...
    <ul class="tabnavigation">
        <li><a href="#tab-overview" title="<?php echo _("Overview"); ?>"><span><?php echo _("Overview"); ?></span></a></li>
        <li><a href="#tab-perfgraphs" title="<?php echo _("Performance Graphs"); ?>"> <span><?php echo _("Performance Graphs"); ?></span></a></li>
        <?php
        if (is_advanced_user()) {
            ?>
            <li><a href="#tab-advanced" title="<?php echo _("Advanced"); ?>"><span><?php echo _("Advanced"); ?></span></a></li>
        <?php
        }
        if ($show_configure == true) {
            ?>
            <li><a href="#tab-configure" title="<?php echo _("Configure"); ?>"> <span><?php echo _("Configure"); ?></span></a></li>
        <?php
        }
        ?>
        <?php
...
?>
    ...
    <?php if(is_neptune()) {  ?>
        <h1 style="display:inline-block; margin-bottom:-10px;"><?php echo _("Host Status Detail"); ?><span class="hoststatustargettext"><span class="neptune-slash">/</span>
    ...
    <?php if (is_neptune()) { ?>
        <div id="tabs" class="hide">
            <ul class="tabnavigation">
                <li><a href="#tab-overview" title="<?php echo _("Overview"); ?>"><span><?php echo _("Overview"); ?></span></a></li>
                <li><a href="#tab-services" title="<?php echo _("Services"); ?>"> <span><?php echo _("Services"); ?></span></a></li>
                <li><a href="#tab-perfgraphs" title="<?php echo _("Performance Graphs"); ?>"> <span><?php echo _("Performance Graphs"); ?></span></a></li>
                <?php
                if (is_advanced_user()) {
                    ?>
        ...
        <table class="table table-condensed table-striped table-bordered">
            ...
            <tbody>
                <tr v-for="service in services" v-bind:key="service.service_object_id">
                    ...
                    <td><div class="scrollable-30 mono text-black-blue-200">{{ service.output }}</div></td>
                </tr>
            </tbody>
            <tfoot>
            </tfoot>
