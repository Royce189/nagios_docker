...
function draw_service_detail_links($hostname, $servicename, $obj = null)
{
    if (is_neptune()) {
        ...
        echo "<div class='btn btn-sm btn-default'><a class='hover:text-foreground text-foreground' href='" . get_service_status_link($hostname, $servicename) . "'>" . _("View Current Status of Service") . "</a></div>";
        ...
        echo "<div class='statusdetaillink'><a href='" . get_service_status_link($hostname, $servicename) . "'><img src='" . theme_image("statusdetailmulti.png") . "' class='tt-bind' alt='" . _("View Current Status of Service") . "' title='" . _("View Current Status For Service") . "'></a></div>";
...
function get_status_view_filters_html($show, $urlargs, $hostattr, $serviceattr, $hoststatustypes, $servicestatustypes, $url = "")
{
    ...
    if ($hostattr != 0 || ($hoststatustypes != 0 && $hoststatustypes != HOSTSTATE_ANY)) {
        ...
        foreach ($filterstrs as $f) {
            if ($x > 0)
                $filters .= get_theme() == "neptune" ? " " : ",";
                $filters .= get_theme() == "neptune" ? "<span class='neptune-badge-item'>" . $f . "</span>" : $f;
                $x++;
            }
    }
