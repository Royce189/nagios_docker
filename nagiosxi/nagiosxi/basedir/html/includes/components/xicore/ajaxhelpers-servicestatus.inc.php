    ...
    if ($xml) {
        foreach ($xml->servicestatus as $x) {
            ...
            if (get_theme() == "neptune"){
                ...
                <td nowrap> <span class='flex text-black-blue-100 justify-start items-center'><span class='material-symbols-outlined neptune-icon-sm text-muted pr-1 pl-0'>timelapse</span>" . $statedurationstr . "</span></td>
                <td>" . $current_attempt . "/" . $max_attempts . "</td>
                <td>" . $last_check . "</td>
                <td style='max-width:400px;' class='mono text-black-blue-200'><div class='scrollable-12' style='padding-bottom:5px;'>" . $status_info . "</div></td>";
            } else {
                $output .= "<tr class='" . $rowclass . "'>
