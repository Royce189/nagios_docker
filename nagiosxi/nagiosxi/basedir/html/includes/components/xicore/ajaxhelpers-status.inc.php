...
function xicore_ajax_get_host_and_service_status_summary_dashboard_html($args = null)
{
    ...
    <div class="neptune-host-service-dashboard-container">
        <div class="neptune-host-service-dashboard-top-row">
            ...
            <div class="neptune-host-service-dashboard-tab border-b neptune-tab-selectable bg-black-blue-1050" data-tab="service">
                <div class="neptune-tab-title">
                    Service
                </div>
                <div class="neptune-tab-info">
        ...
        <div class="neptune-host-service-dashboard-bottom-row">
                ...
                <div class="neptune-graph-container" id="neptune-graph-container">
                    <div class="neptune-graph-header">
                        <div class="status-dot-array" style="padding-left:20px;font-size:16px;">
                            <span class="status-dot-text text-black-blue-200"><span style="margin-right:6px" class="status-dot dot-8 hostup"></span>Up</span>
                            <span class="status-dot-text text-black-blue-200"><span style="margin-right:6px" class="status-dot dot-8 hostdown"></span>Down</span>
                            <span class="status-dot-text text-black-blue-200"><span style="margin-right:6px" class="status-dot dot-8 hostunreachable-dashboard"></span>Unreachable</span>
                            <span class="status-dot-text text-black-blue-200"><span style="margin-right:6px" class="status-dot dot-8 hostunhandled"></span>Unhandled</span>
                            <span class="status-dot-text text-black-blue-200"><span style="margin-right:6px" class="status-dot dot-8 hostproblem"></span>Problems</span>
                            <span class="status-dot-text text-black-blue-200"><span style="margin-right:6px" class="status-dot dot-8 hostpending-dashboard"></span>Pending</span>
                        </div>
            ...
            <div class="neptune-graph-header">
                <div class="status-dot-array" style="padding-left:20px;font-size:16px;">
                    <span class="status-dot-text text-black-blue-200"><span style="margin-right:6px" class="status-dot dot-8 hostup"></span>OK</span>
                    <span class="status-dot-text text-black-blue-200"><span style="margin-right:6px" class="status-dot dot-8 servicewarning-dashboard"></span>Warning</span>
                    <span class="status-dot-text text-black-blue-200"><span style="margin-right:6px" class="status-dot dot-8 servicecritical-dashboard"></span>Critical</span>
                    <span class="status-dot-text text-black-blue-200"><span style="margin-right:6px" class="status-dot dot-8 serviceunknown-dashboard"></span>Unknown</span>
                    <span class="status-dot-text text-black-blue-200"><span style="margin-right:6px" class="status-dot dot-8 serviceunhandled"></span>Unhandled</span>
                    <span class="status-dot-text text-black-blue-200"><span style="margin-right:6px" class="status-dot dot-8 serviceproblem"></span>Problem</span>
                    <span class="status-dot-text text-black-blue-200"><span style="margin-right:6px" class="status-dot dot-8 servicepending-dashboard"></span>Pending</span>
                </div>
                <div class="neptune-graph-header-info">
                        <div class="neptune-graph-header-tabs">
                            <div class="neptune-scale-tab neptune-scale-tab-active" data-scale="linear">Linear</div>
    ...
    $(document).ready(function() {
        ...
        function switchTab(tabName) {
            ...
            $(".neptune-host-service-dashboard-tab")
                .addClass("border-b bg-black-blue-1050 neptune-tab-selectable")
                .removeClass("active")
                .filter("[data-tab=\'" + tabName + "\']")
                .removeClass("border-b bg-black-blue-1050 neptune-tab-selectable")
                .addClass("active");
...
$(document).ready(function() {
        ...
        window.hostChart = Highcharts.chart(\'neptune-graph-body\', {
            ...
            tooltip: {
                backgroundColor: \'#070A0D\', // Change the background color of the tooltip
                borderColor: \'#2A3B51\',
                borderWidth:1,
                style: {
                    color: \'#FFF\', // Change the text color inside the tooltip
                    fontSize: \'14px\',
                },
            }
        });
