        ...
        success: function(dt) {
            ...
            if (Object.keys(dt).length > 0) {
                $.each(dt, function(k, d) {
                    ...
                    html += '<td class="center"><a class="remove dt-tt-bind" data-downtime-type="'+d.type+'" data-downtime-id="'+d.downtime_id+'" data-placement="left" title="<?php echo _("Remove"); ?>"><span class="material-symbols-outlined md-button">delete</span></a></td>';
            ...
            $('.refresh').html('<i class="material-symbols-outlined md-button md-action md-400 md-20">refresh</i>');
        }
    });
}
...
<div class="well report-options">
    <div class="fl" style="height: 29px; margin-right: 30px; margin-bottom: 15px;">
        ...
        <a class="tt-bind settings-dropdown" id="open-dtform" data-placement="right" title="<?php echo _('Edit page settings'); ?>"><i class="material-symbols-outlined md-button md-action md-20 md-400">settings</i></a>
    ...
    <div class="input-group h-9 " style="width: 240px; display: inline-table;">
    ...
    <div class="fr">
        <form action="" method="get" id="search-form" style="margin: 0;">
            <input type="text" id="search" class="rounded-r-none form-control" placeholder="<?php echo _('Search'); ?>..." style="vertical-align: top; border-right: 0;"><button type="submit" class="rounded-l-none btn btn-sm btn-default tt-bind" data-placement="bottom" title="<?php echo _('Search'); ?>"><i class="fa fa-search"></i></button>
...
<div style="padding: 0 0 10px 0;">
    ...
    <div class="fr">
        <div class="ajax-pagination neptune-ajax-pagination" style="margin: 3px 0 0 0;">
            <button class="btn btn-xs btn-default first-page h-8" title="<?php echo _('First Page'); ?>"><i class="fa fa-fast-backward"></i></button>
            <button class="btn btn-xs btn-default previous-page h-8" title="<?php echo _('Previous Page'); ?>" disabled><i class="fa fa-chevron-left l"></i></button>
            ...
            <button class="btn btn-xs btn-default next-page h-8" title="<?php echo _('Next Page'); ?>"><i class="fa fa-chevron-right r"></i></button>
            <button class="btn btn-xs btn-default last-page h-8" title="<?php echo _('Last Page'); ?>"><i class="fa fa-fast-forward"></i></button>
            ...
            <div class="flex items-center gap-0.5">
                <input type="text" class="form-control rounded-r-none condensed jump-to h-8">
                <button class="btn btn-xs btn-default tt-bind rounded-l-none border-l-none jump h-8" title="<?php echo _('Jump to Page'); ?>"><i class="fa fa-chevron-circle-right fa-12"></i></button>
            </div>
        </div>
    </div>
    <div class="clear"></div>
...
<div>
    ...
    <div class="fr">
        <div class="ajax-pagination neptune-ajax-pagination" style="margin: 20px 0 0 0;">
            <button class="btn btn-xs btn-default first-page h-8" title="<?php echo _('First Page'); ?>"><i class="fa fa-fast-backward"></i></button>
            <button class="btn btn-xs btn-default previous-page  h-8" title="<?php echo _('Previous Page'); ?>" disabled><i class="fa fa-chevron-left l"></i></button>
            <span class="page-count-margin" style="margin: 0 10px;"><?php echo _('Page'); ?> <span class="pagenum">1 <?php echo _('of'); ?> <?php echo $pager_results['total_pages']; ?></span></span>
            <button class="btn btn-xs btn-default next-page  h-8" title="<?php echo _('Next Page'); ?>"><i class="fa fa-chevron-right r"></i></button>
...
$(document).ready(function() {
    ...
    if (theme != "neptune") { $('.filter-services-by-host').searchable({ maxMultiMatch: 9999 }); }
...
<form action="?cmd=submit" method="post">
    ...
    <table class="table table-auto-width table-no-border" style="width: 50%; min-width: 800px;">
        ...
        <tr>
            <td colspan="2">
                <div class="well rounded-md" style="margin: 0; min-height: 340px;">
                    <div style="width: 50%; padding-right: 20px;" class="fl hosts-select">
                        ...
                        <div class="neptune-scheduled-downtime-area">
                            <select id="neptune-host-area-box" class="form-control hosts h-full" style="height: 237px; width: 100%;" multiple>
                                <?php
                    ...
                    <div style="width: 50%;" class="fr hosts-selected">
                        <div>
                            <table class="table table-bordered table-condensed bg-background border-b-none">
                                <thead>
                                    <tr>
                                        <th class="rounded-md">
                            ...
                            <div class="selected-hosts-box">
                                <table class="table table-condensed bg-background border-none">
            ...
            <td colspan="2">
                ...
                <div class="well" style="margin: 0; min-height: 340px;">
                    <div style="width: 50%; padding-right: 20px;" class="fl hosts-select">
                        ...
                        <div class="neptune-scheduled-downtime-area">
                            <select id="neptune-service-area-box" class="form-control services h-full" style="height: 237px; width: 100%; border-top: 0;" multiple></select>
                        </div>
                        <div style="margin-top: 5px;">
        ...
        <tr>
            ...
            <td><input type="text" name="com_author" value="<?php echo encode_form_valq(get_user_attr(0, 'name')); ?>" class="form-control" readonly></td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                <div class="well" style="margin: 0; min-height: 340px;">
                    <div style="width: 50%; padding-right: 20px;" class="fl hostgroups-select">
                        ...
                        <div class="neptune-scheduled-downtime-area">
                            <select id="neptune-hostgroup-area-box" class="form-control hostgroups" style="height: 237px; width: 100%;" multiple>
                                <?php
            ...
            <td colspan="2">
                <div class="well" style="margin: 0; min-height: 340px;">
                    <div style="width: 50%; padding-right: 20px;" class="fl servicegroups-select">
                        ...
                        <div class="neptune-scheduled-downtime-area">
                            <select id="neptune-servicegroup-area-box" class="form-control servicegroups" style="height: 237px; width: 100%;" multiple>
                                <?php
