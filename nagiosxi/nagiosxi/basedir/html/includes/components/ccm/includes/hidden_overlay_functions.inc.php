...
function build_variable_box()
{
    ...
    <div class='overlay' id='variableBox' style='max-width: 900px;'>
        ...
        <div class='overlay-title'>
            ...
            <div class='overlay-close ccm-tt-bind' data-placement='left' title='"._('Close')."' onclick='killOverlay(\"variableBox\")'><span class='material-symbols-outlined'>close</span></div>
            <div class='clear'></div>
        </div>
        ...
        <div class='well form-horizontal' style='margin: 20px 0 10px 0;'>
            ...
            <button style='vertical-align: top;' type='button' class='btn btn-sm btn-primary icon-in-btn' onclick='insertDefinition(false, false)'>"._("Insert")." <span class='material-symbols-outlined material-symbols-bold'>chevron_right</span></button>
        </div>
    ...
    if (is_neptune()){
        ...
        <div class='overlay' id='variableBox' style='max-width: 900px;'>
            ...
            <div class='overlay-title'>
                <h2>"._('Manage Custom Variables')."</h2>
                <div class='overlay-close ccm-tt-bind' data-placement='left' title='"._('Close')."' onclick='killOverlay(\"variableBox\")'><span class='material-symbols-outlined md-400 ccm-close-icon'>close</span></div>
                <div class='clear'></div>
            </div>

            <div style='height: calc(100% - 40px); overflow-y: auto;'>

            <table class='table table-hover table-assigned table-condensed table-bordered table-ccm table-stripe' id='tblVariables'>
                <thead>
                    <tr>
                        <th style='width: 43%;'>"._("Name")."</th>
                        <th style='width: 43%;'>"._("Value")."</th>
                        <th style='width: 14%;'>"._("Actions")."</th>
                    </tr>
                </thead>
                <tbody>
                    <!-- insert selected items here -->
            ...
            <div class='well form-horizontal neptune-insert-variable' style='margin: 20px 0 10px 0;'>
                <input type='text' class='form-control' name='txtVariablename' id='txtVariablename' style='width:225px' placeholder='"._('Name')."'>
                <input type='text' class='form-control' name='txtVariablevalue' id='txtVariablevalue' style='width:225px' placeholder='"._('Value')."'>
                <button style='vertical-align: top;' type='button' class='btn btn-sm btn-primary' onclick='insertDefinition(false, false)'>"._("Insert")." <span class='material-symbols-outlined material-symbols-bold'>chevron_right</span></button>
            </div>
