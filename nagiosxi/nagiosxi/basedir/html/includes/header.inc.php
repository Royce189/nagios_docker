...
<?php if ($theme == "xi5" || $theme == "xi5dark" ||$theme == 'neptune' ||  $theme == "colorblind") { ?>
    <script>
    ...
    <div id="help-button-div" class="btn-group">
        ...
        <ul class="dropdown-menu" role="menu" aria-labelledby="dLabel" style="left: initial; right: 0;">
            ...
            <li>
                <a href="https://answerhub.nagios.com/support/s/" target="_blank">
                    <i class="fa fa-life-ring dropdown-icon fa-lg"></i>
                    <span><?php echo _("Support"); ?></span>
                </a>
            </li>
            <li>
                <a href="https://support.nagios.com/forum/" target="_blank">
                    <i class="fa fa-users dropdown-icon fa-lg"></i>
                    <span><?php echo _("Community Forums"); ?></span>
                </a>
            </li>
            <li>
                <a href="https://exchange.nagios.org/" target="_blank">
            ...
            <li role="presentation" class="divider"></li>
            <li>
                <a href="https://www.nagios.com/change-log/" target="_blank">
